...
class PrettyWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
       ...
       # score_function = Initialization_function.get_prediction_function()
        ...
        for file in os.listdir("/home/callbarian/AnomalyDetecionCVPR2018-master/SampleVideos")
            read_file = "/home/callbarian/AnomalyDetecionCVPR2018-master/SampleVideos/"+ file   
    ...
    def SingleBrowse(self):
        video_path, _ = QtWidgets.QFileDialog.getOpenFileName(self,
                                                        'Single File',
                                                        "/home/callbarian/AnomalyDetecionCVPR2018-master/SampleVideos")
